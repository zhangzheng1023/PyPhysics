...
def silver_659nm_test():
    ...
    silver_659nm_dielectric = spp.convert_refractive_dielectric(silver_659nm_refractive)
    ...
    beta = spp.calculate_propagation_constant(silver_659nm_dielectric, air_dielectric, lambda_0)
    ...
    dielectric_constant_3 = spp.convert_refractive_dielectric(1.6)
    print (dielectric_constant_3)
    theta = spp.calculate_kretschmann_theta(beta, dielectric_constant_3, lambda_0)
...
def comsol_test():
    ...
    dielectric_2 = spp.convert_refractive_dielectric(refractive_2)
    beta = spp.calculate_propagation_constant(silver_659nm_dielectric, dielectric_2, lambda_0)
    length = spp.calculate_spp_propagation_length(beta)
    dielectric_constant_3 = spp.convert_refractive_dielectric(1.75)
    theta = spp.calculate_kretschmann_theta(beta, dielectric_constant_3, lambda_0)
    print ("SPP传播长度为{}微米\ntheta角度为{}[rad]{}[deg]\n对应的alpha角度为{}[deg]"
